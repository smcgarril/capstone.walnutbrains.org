...
public class RequestAuthProvider implements AuthProvider {
    ...
    @Override
    public void register(String username, String firstName, String lastName, String email, String password, String role, String securityQuestion, String securityAnswer, String category1, String category2, String neighborhood1, String neighborhood2) {
        dao.saveUser(username, firstName, lastName, email, password, role, securityQuestion, securityAnswer, category1, category2, neighborhood1, neighborhood2);
    }
