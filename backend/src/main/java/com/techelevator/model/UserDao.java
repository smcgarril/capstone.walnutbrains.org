...
public interface UserDao {
     ...
     * @return the new user
     */
    public User saveUser(String userName, String firstName, String lastName, String email, String password, String role, String securityQuestion, String securityAnswer,   
